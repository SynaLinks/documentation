...
To build custom retrievers you need to create an object that inherit from the `dspy.Retrieve` Object.
For that you only needs to implement the `forward` method. Here is the code of the DocumentRetriever to help you understand how to implement your own:
